...
class StreamingMixin:
    ...
    def __init__(self, **kwargs):
        ...
        self._streaming_reader = None  # ✅ Initialisé plus tard quand self.path est disponible
    ...
    def _get_streaming_reader(
        ...
        if not self.enable_streaming:
            raise RuntimeError("Streaming not enabled. Set enable_streaming=True in constructor.")
